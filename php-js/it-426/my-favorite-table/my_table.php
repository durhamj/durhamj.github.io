...
$data = [
        'album' => ['Bleach', 'Superunkown', 'The Fragile', 'OK Computer'],
        'releaseDate' => ['June 15, 1989', 'September 21, 1999', 'January 25, 1994', 'May 21, 1997'],
        'coverArt' => ['<img src="images/bleach.jpg" alt="bleach cover art">', '<img src="images/superunknown.jpg" alt="Superunknown cover art">', '<img src="images/fragile.jpg" alt="The Fragile cover art">', '<img src="images/ok-computer.jpg" alt="OK Computer cover art">'],
